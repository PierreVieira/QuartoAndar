...
import {FiPower, FiTrash2, FiTrello} from 'react-icons/fi';
                ...
                {property.filter(property => property.bairro === "Bairro1").map(property => (
                    <li key={property.id}>
                        ...
                        <div className="data-register">
                            <input type="date"/>
                            <input type="time"/>
                            <button className="button-cadastrar-data">Cadastrar Data</button>
                        </div>
                    </li>
                ))}
            </ul>
